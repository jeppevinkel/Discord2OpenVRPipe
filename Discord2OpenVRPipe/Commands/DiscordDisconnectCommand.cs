...
public class DiscordDisconnectCommand : CommandBase
{
    private readonly DiscordConfigViewModel _discordConfigViewModel;

    public DiscordDisconnectCommand(DiscordConfigViewModel discordConfigViewModel)
    {
    ...
    {
        _discordConfigViewModel.IsConnected = false;
    }
}